...
Más allá de la inmediatez de los requisitos operativos, cuando tenés un modelo de un sistema, podés hacer mejores predicciones sobre cómo se va a comportar a largo plazo. Esto significa predecir los costos de satisfacer las necesidades de los equipos y los clientes. Significa la capacidad de invertir cuando es necesario y no hasta que es realmente neceario, y te permite comprender la cantidad correcta a invertir.
...
- Autoría de [Mark Dennehy](https://medium.com/@MarkDennehy), traducción por [@nachichuri](https://twitter.com/Nachichuri), revisión por [@?](https://twitter.com/?).